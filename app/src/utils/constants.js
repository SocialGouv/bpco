...
export const STORAGE_KEY_OXYGEN = "@OXYGEN";
export const STORAGE_KEY_VENTILATION_DEVICE = "@STORAGE_KEY_VENTILATION_DEVICE";
...
export const STORAGE_KEY_AGE = "@AGE";
export const STORAGE_KEY_WEIGHT = "@WEIGHT";
