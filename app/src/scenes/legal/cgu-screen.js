...
const CGU = ({ navigation }) => {
  const content = (
    <View>
      <Text style={styles.default}>
        ...
        «&nbsp;CGU&nbsp;») fixent le cadre juridique de l'application BPCO et
      ...
      <Text style={styles.default}>
        «&nbsp;BPCO&nbsp;» vise à accompagner les personnes qui le souhaitent à
        mieux connaître et suivre leurs symptômes, leurs ressentis ou toute
        activité personnalisé, leur permettant ainsi de faciliter leur
      ...
      <Text style={styles.default}>
        ...
        totalement libre. Pour ce faire, BPCO met à sa disposition un espace
        «&nbsp;note&nbsp;», dont l'ensemble des informations demeurent sur le
      ...
      <Text style={styles.default}>
        ...
        transférée à l'équipe de BPCO.
      </Text>
      <Text style={styles.h2}>4.7 - Contacter l'équipe de BPCO </Text>
      <Text style={styles.default}>
        Via la fonction «&nbsp;contribuer à BPCO&nbsp;», l'application permet la
        mise en contact avec l'équipe si l'Utilisateur souhaite transférer ses
      ...
      <Text style={styles.default}>
        ...
        fiables mais BPCO ne garantit pas qu'il soit exempt de défauts,
      ...
      <Text style={styles.default}>
        L'Utilisateur s'engage à une utilisation personnelle de BPCO.
      </Text>
  ...
  return (
    <LegalScreen
      ...
      title="Conditions d'utilisation de l'application BPCO"
      content={content}
    />
  );
};
