  ...
  const content = (
    <View>
      ...
      <Text style={styles.default}>
        La présente application BPCO est à l'initiative de la Direction Générale
        de la Santé au sein de la Fabrique numérique des ministères sociaux.
      </Text>
      <Text style={styles.h2}>Finalité </Text>
      <Text style={styles.default}>
        L'application «&nbsp;BPCO&nbsp;» vise à accompagner les personnes qui le
        souhaitent à mieux connaître et suivre leurs symptômes, leurs ressentis
        ou toute activité personnalisée, leur permettant de faciliter leur
        accompagnement psychologique. L'application permet notamment&nbsp;:
      </Text>
      <Li>
        <Text style={styles.default}>
      ...
      <Li>
        <Text style={styles.default}>
          L'envoi de données saisies par mail à toute personne choisie par
          l'utilisateur.
        </Text>
      </Li>
      <Text style={styles.h2}>Données à caractère personnel traitées</Text>
      <Text style={styles.default}>
        Peuvent être traitées les données suivantes :
      </Text>
      <Li>
        <Text style={styles.default}>
          Données de contact (adresse e-mail et numéro de téléphone)&nbsp;;{" "}
          <Text style={styles.bold}>
            La communication de ces données est une simple possibilité proposée
            pour l'amélioration de l'application.
          </Text>
        </Text>
      </Li>
      <Li>
      ...
      <Text style={[styles.default, styles.bold]}>
        Les données relatives aux notes libres et au suivi sont conservées sur
        le terminal de l'utilisateur et ne sont pas transférées à l'équipe BPCO,
        à la Fabrique numérique des ministères sociaux ou à la Direction
      ...
      <Text style={styles.default}>
        ...
        décret n°2021-1363 portant injonction, au regard de la menace grave et
        actuelle contre la sécurité nationale, de conservation pour une durée
      ...
      <Text style={styles.default}>
        ...
        nous permettre de retrouver votre recherche&nbsp;:
      </Text>
      <Li>
        <Text style={styles.default}>
      ...
      <Li>
        <Text style={styles.default}>
          ...
          {"\n"}
          <TouchableOpacity
            onPress={() => Linking.openURL("https://fr.tipimail.com/rgpd")}
          >
      ...
      <Text style={styles.default}>
        ...
        d'une application. Il a pour but de collecter des informations relatives
      ...
      <Text style={styles.default}>
        ...
        auquel aura accès l'équipe de BPCO.
      </Text>
      ...
      <Li>
        ...
        >
          <Text style={[styles.default, styles.link]}>
    ...
    <View style={styles.table}>
      <View style={[styles.tableRow, styles.tableHeader]}>
        <View style={styles.tableCol}>
          <Text style={[styles.default, styles.center, styles.bold]}>
            Type de données
          </Text>
        </View>
        <View style={styles.tableCol}>
      ...
      <View style={styles.tableRow}>
        ...
        <View style={styles.tableCol}>
          <Text style={styles.default}>
            <Text style={styles.bold}>Dans un délai de 3 ans</Text> à compter de
      ...
      <View style={styles.tableRow}>
        <View style={styles.tableCol}>
          <Text style={styles.default}>
            ...
            <Text style={styles.bold}>
              (stockées sur le terminal de l'utilisateur sans aucun autre accès
              possible)
            </Text>
          </Text>
        </View>
        <View style={styles.tableCol}>
          <Text style={[styles.default, styles.bold]}>
            Dès la suppression par la personne concernée
          </Text>
        </View>
      </View>
      <View style={styles.tableRow}>
        ...
        <View style={styles.tableCol}>
          <Text style={styles.default}>
            <Text style={styles.bold}>1 an</Text>, conformément au décret
      ...
      <View style={styles.tableRow}>
        ...
        <View style={styles.tableCol}>
          <Text style={styles.default}>
            <Text style={styles.bold}>Dans un délai de 13 mois</Text>,
